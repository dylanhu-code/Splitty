...
public class EmailController {
     ...
     */
    @PostMapping
    public ResponseEntity<Email> sendEmail(@RequestBody Email request) {
        service.sendEmail(request.getToRecipient(), request.getEmailSubject(), request.getEmailBody(),
                request.getEmailUsername(), request.getEmailPassword());
